                                    ...
                                    <div class="row row-cards">
                                        <div class="col-sm-6 col-md-4">
                                            <div class="mb-3">
                                                ...
                                                <input type="text" class="form-control" id="nomor_penyelesaian_kasus"
                                                    name="nomor_penyelesaian_kasus" required>
                                        ...
                                        <div class="col-sm-6 col-md-4">
                                            <div class="mb-3">
                                                ...
                                                <input type="text" class="form-control" id="nama_penyelesaian_kasus"
                                                    name="nama_penyelesaian_kasus" required>
                                        ...
                                        <div class="col-sm-6 col-md-4">
                                            <div class="mb-3">
                                                ...
                                                <input type="text" class="form-control" id="cara_menyelesaikan"
                                                    name="cara_menyelesaikan" required>
                                        ...
                                        <div class="col-sm-6 col-md-4">
                                            <div class="mb-3">
                                                ...
                                                <textarea class="form-control" id="keterangan_penyelesaian_kasus" name="keterangan_penyelesaian_kasus" required>{{ old('keterangan_penyelesaian_kasus') }}</textarea>
                                    ...
                                    <div class="row row-cards">
                                        ...
                                        <div class="col-sm-6 col-md-4">
                                            <div class="mb-3">
                                                ...
                                                <input type="text" class="form-control" id="tempat_kunjungan"
                                                    name="tempat_kunjungan" required>
                                        ...
                                        <div class="col-sm-6 col-md-4">
                                            <div class="mb-3">
                                                ...
                                                <textarea class="form-control" id="keterangan_hubin" name="keterangan_hubin" required>{{ old('keterangan_hubin') }}</textarea>
                                        ...
                                        <div class="col-sm-6 col-md-4">
                                            <div class="mb-3">
                                                ...
                                                <input type="text" class="form-control" id="nomor_pelatihan_siswa"
                                                    name="nomor_pelatihan_siswa" required>
                                        ...
                                        <div class="col-sm-6 col-md-4">
                                            <div class="mb-3">
                                                ...
                                                <input type="text" class="form-control" id="nama_pelatihan_siswa"
                                                    name="nama_pelatihan_siswa" required>
                                        ...
                                        <div class="col-sm-6 col-md-4">
                                            <div class="mb-3">
                                                ...
                                                <input type="text" class="form-control" id="hasil_pelatihan_siswa"
                                                    name="hasil_pelatihan_siswa" required>
                                    ...
                                    <div class="row row-cards">
                                        ...
                                        <div class="col-sm-6 col-md-4">
                                            <div class="mb-3">
                                                ...
                                                <textarea class="form-control" id="keterangan_seminar" name="keterangan_seminar" required>{{ old('keterangan_seminar') }}</textarea>
